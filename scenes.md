...
- Joce flashback ft. neighbors and letters
	- gets sprain via parkour
	- poster is Important

&nbsp;

- (maybe instead of "fuck no" it's "aight. here we go")
...
- post-credits/bonus: WR joins the alliance
	- Addison outfit change, including pendant

## 2

- last night: Addison @ WR alliance proposal
	- handshake shown, not completed

&nbsp;

- J+KL "listening"; Addison+crew shows up
	- landscape loops, not explicit yet
	- Addison ignores KL
	- handshake offered, rejected
...
- A+C motive talk; pendant key, set off Bad
